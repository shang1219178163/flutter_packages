...
///   (Icons.directions_car, StepState.disabled),
///   (Icons.directions_boat, StepState.error),
/// ];
...
///       icon: Icon(e.$1, color: Colors.blue, size: 40,),
///       state: StepState.values[tuples.indexOf(e)],
///       isActive: _index == tuples.indexOf(e),
///       horizontalLinePosition = HorizontalLinePosition.top,
///       title: Text("step ${tuples.indexOf(e)}"),
///       subtitle: Text("subtitle_${tuples.indexOf(e)}_${e.$2.toString()}",),
...
class _EnStepperState extends State<EnStepper> with TickerProviderStateMixin {
  ...
  Widget _buildCircle(int index, bool oldState) {
    EnStep step = widget.steps[index];
