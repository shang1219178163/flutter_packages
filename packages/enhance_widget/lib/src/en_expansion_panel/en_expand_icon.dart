...
class EnExpandIcon extends StatefulWidget {
  /// Creates an [EnExpandIcon] with the given padding, and a callback that is
  ...
  @override
  State<EnExpandIcon> createState() => _EnExpandIconState();
}

class _EnExpandIconState extends State<EnExpandIcon> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(EnExpandIcon oldWidget) {
