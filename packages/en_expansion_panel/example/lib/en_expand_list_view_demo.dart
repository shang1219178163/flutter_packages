...
import 'package:en_expansion_panel/en_expansion_panel.dart';
import 'package:flutter/material.dart';

class EnExpandListViewDemo extends StatefulWidget {
  final String? title;

  const EnExpandListViewDemo({super.key, this.title});

  @override
  State<EnExpandListViewDemo> createState() =>
      _EnExpandListViewDemoState();
}

class _EnExpandListViewDemoState extends State<EnExpandListViewDemo> {
  final _sections = [
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: EnExpandListView(
          children: _sections
              .map<ExpandPanelModel<(String, String)>>(
                  (e) => ExpandPanelModel(
                        canTapOnHeader: true,
                        isExpanded: false,
                        arrowPosition: EnExpansionPanelArrowPosition.none,
