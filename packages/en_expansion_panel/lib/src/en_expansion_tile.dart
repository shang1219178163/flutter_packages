...
///
/// {@tool dartpad}
/// This example demonstrates different configurations of EnExpansionTile.
///
...
class EnExpansionTile extends StatefulWidget {
  ...
  ///
  /// If this property is null then [EnExpansionTileThemeData.backgroundColor] is used. If that
  /// is also null then Colors.transparent is used.
  ///
  /// See also:
  ///
  /// * [EnExpansionTileTheme.of], which returns the nearest [EnExpansionTileTheme]'s
  ///   [EnExpansionTileThemeData].
  final Color? backgroundColor;

  /// When not null, defines the background color of tile when the sublist is collapsed.
  ///
  /// If this property is null then [EnExpansionTileThemeData.collapsedBackgroundColor] is used.
  ...
  ///
  /// If this property is null then [EnExpansionTileThemeData.tilePadding] is used. If that
  ...
  ///
  /// If this property is null then [EnExpansionTileThemeData.expandedAlignment]is used. If that
  ...
  ///
  /// If this property is null then [EnExpansionTileThemeData.childrenPadding] is used. If that
  ...
  ///
  /// If this property is null then [EnExpansionTileThemeData.iconColor] is used. If that
  ...
  ///
  /// If this property is null then [EnExpansionTileThemeData.textColor] is used. If that
  ...
  /// Used to override to the [ListTileThemeData.textColor].
  ///
  /// If this property is null then [EnExpansionTileThemeData.collapsedTextColor] is used. If that
  /// is also null then the value of [ListTileThemeData.textColor] is used.
  ///
  /// See also:
  ///
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            widget.childrenHeader?.call(_isExpanded, _handleTap) ?? const SizedBox(),
            ClipRect(
              child: Align(
            ...
            widget.childrenFooter?.call(_isExpanded, _handleTap) ?? const SizedBox(),
          ],
        ),
      ),
    );
