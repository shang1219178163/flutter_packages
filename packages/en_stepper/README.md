...
[![pub](https://img.shields.io/pub/v/en_stepper.svg)](https://pub.dev/packages/en_stepper)
...
<p>
<img src="https://raw.githubusercontent.com/shang1219178163/flutter_packages/main/packages/en_stepper/screenshot/Simulator%20Screen%20Shot%20-%20iPhone%2011%20Pro%20-%202021-07-02%20at%2015.53.19.png" width="220">
<img src="https://raw.githubusercontent.com/shang1219178163/flutter_packages/main/packages/en_stepper/screenshot/Simulator%20Screen%20Shot%20-%20iPhone%2011%20Pro%20-%202021-07-02%20at%2015.53.22.png" width="220">
</p>
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<(IconData, StepState)> tuples = [
  ...
  Widget buildStepperCustom(BuildContext context) {
    return EnStepper(
        ...
        steps: tuples.map((e) => EnStep(
          icon: Icon(e.$1, color: Colors.blue, size: 30,),
          state: StepState.values[tuples.indexOf(e)],
          isActive: _index == tuples.indexOf(e),
          title: Text("step ${tuples.indexOf(e)}"),
          subtitle: Text("${e.$2.toString().split(".").last}",),
